<?php
    ...
    try {
        ...
        $stmt = $conn->prepare("INSERT INTO pentesting.sqlscanlog (id, date_time, name, email, ipaddress, websitescanned) VALUES (:id, NOW(), :name, :email, :ipaddress, :websitescanned)");
